    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="#"><i class="fas fa-piggy-bank" style="color: #4dabf7"> Deposit </i><span class="sr-only">(current)</span></a>
                </li>
                <!-- <li class="nav-item active">
                    <a class="nav-link" href="balance.php"><i class="fas fa-wallet"> Current Balance</i><span class="sr-only">(current)</span></a>
                </li> -->
        ...
        <form class="form-inline my-2 my-lg-0" action="logout.php" method="POST">
                ...
                <button class="btn btn-outline-primary my-2 my-sm-0" id="searchbu" type="submit" name="logout">Logout</button>
            </form>
    </nav>
    <br>
    <center>
        <div class="card shadow-lg p-3 mb-5 bg-white rounded " style="width: 18rem;">
            <img src="assets/img/undraw_Savings_dwkw.png" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">Deposit</h5>
                <form method="POST" action="depositconn.php">
                <input type="text" style="height: 30px;font-size: 16px;padding-left: 3px;border-radius: 5px" placeholder="Enter amount" name="withdraw"><br><br>
                <button class="btn btn-primary" type="submit" name='dept'>Confirm</button>
                </form>
            </div>
        </div>
    </center>
